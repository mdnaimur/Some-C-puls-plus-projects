...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(265, 69);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(24, 13);
			this->label1->TabIndex = 129;
			this->label1->Text = L"ITC";
			// 
			// textBox1
			// 
			...
			this->label2->Location = System::Drawing::Point(265, 95);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(47, 13);
			this->label2->TabIndex = 131;
			this->label2->Text = L"ITC LAB";
			// 
			// textBox3
			// 
...
private: System::Void comboBox1_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e) {
			...
			String^ constring = L"datasource=localhost;port=3306;username=root;password=Fat 0126";// this will connect to database
				 ...
				 MySqlCommand^ cmdDataBase = gcnew MySqlCommand(" select * from adminlog.marks1 where idStudent='"+comboval+"';",conDataBase);// semi colomn is used to close querry
