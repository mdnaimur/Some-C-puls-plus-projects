...
***INTRODUCTION***
/////////////////////////////
NAME:- BHAVISHAY NIGAM CLASS:- XII SEC:- 'N.M' ROLL NO:- '8'
/////////////////////////////
#################### #
STAR COMPUTERS
# ####################
...
//#include<iomainp> //for setw function
...

        {
             clrscr();
              ...
              void display()
              {
                  ...
                  cout<>ch; if(ch=='y')
                  {
                      f1.write((char*)&c,sizeof(c)); } f1.close();
                      }
...
f1.read((char*)&c,sizeof(c));if(c.rcno()==rno)
{
c.display();
found='t';
...
void update()
{
    ...
    cin>>rno; while(!f1.eof())
    {
         pos=f1.tellg();
         f1.read((char*)&c,sizeof(c));
         if(c.rcno()==rno) { c.entry();
         f1.seekg(pos);
...
exit(0);
 ...
 goto pass;
  ...
  printf(" \n");
   printf("********************************************************************************"); textcolor(BLACK+WHITE+BLINK); cout<<"\n"; cputs (" WELCOME TO THE S.T.A.R COMPUTERS \n"); printf("********************************************************************************\n"); printf("********************************************************************************\n");
    gotoxy(2,21);
    textcolor(GREEN);
...
else if(p1==3)
{
    ...
    { pend=1800;
} else if(p1==6) { pend=2400; }
else if(p1==7) { pend=3000; }
else if(p1==0)
    { goto items; }
 ...
 cout<<" 3.PHOTO SCANNER\t\t\t4500\n";
  cout<<" 4.FILM SCANNER\t\t\t8000\n";
   cout<<" 5.PORTABLE SCANNER\t\t\t10000\n";
    ...
    cin>>scan; if(scan==1)
    { asc=5000; } else if(scan==2)
    {
         asc=6000; }
          else if(scan==3)
            { asc=4500; }
 else if(scan==4) { asc=8000; }
  else if(scan==5) { asc=10000; }
   else if(scan==0)
    { goto items; }
 ...
 //GO BACK TO PURCHASE LIST
   ...
   //TO DISPLAY BILL
     ...
     c.display();
      ...
      cout<<"\n\n\n\n";
      cout<<"===============================================================================";
      cout<<"\nITEMS" <0) cout<<"\n\nPENDRIVE" <0) cout<<"\n\nSCANNER" <0) cout<<"\n\nPRINTER" <0) cout<<"\n\nWEBCAM" <0) cout<<"\n\nGRAPHIC CARD" <0) cout<<"\n\nRAM" <0) cout<<"\n\nHARD DISK" <0) cout<<"\n\nWINDOWS ORIGINAL CD" <0) cout<<"\n\nANTIVIRUS" <0) cout<<"\n\nMOUSE" <>total; cout<<"\n\n\n\t\t\tCASH RECIEVED :"<0||n>0||o>0||p>0||q>0||r>0||s>0||t>0||u>0||v>0) { cout<<"\n\t\t\tItems Avaliable in shop.\n\n\n"; cout<<"==============================================================================="; cout<<"\nITEMS" <>et; if(et=='y') { goto ex; } else { goto again; } ex:; clrscr(); textcolor(RED); sleep(1); clrscr(); gotoxy(35,10); cout<<" THANKS "; sleep(1); clrscr(); gotoxy(35,20); cout<<" THANKS "; sleep(1); clrscr(); gotoxy(28,30); cout<<" THANK YOU FOR USING THE PROJECT\n\n\n\n ";
      gotoxy(35,35); 
      ...
      cputs("Press ENTER to EXIT......."); getch(); exit(0);
       default: cout<<"OOPS!!!!!!!! Your choice is WRONG"; getch(); goto again;
       }
       }
        }
